...
/********************  Configuration  ************************/
static double shrink_tao = 1e-8; // default 1e-8
static double conv_thres = 1e-5; // default 1e-5
static double NEAR_ZERO = 1e-10; // default 1e-10

static double r_limit = 0.35; // default 0.4
